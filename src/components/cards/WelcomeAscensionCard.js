...
import BaseAscensionCard from './BaseAscensionCard';

class WelcomeAscensionCard extends BaseAscensionCard {
  constructor() {
    super();
    this.name = 'WelcomeAscensionCard';
  ...
  render() {
    ...
    return (
        <>
        <div className={`card`, styles.overlayImg } style={{ backgroundImage: `url("${__PUBLIC_PATH__}/images/sunnyday.png")` }}>
...
export default React.forwardRef((props, ref) => <WelcomeAscensionCard 
  innerRef={ref} {...props}
/>);